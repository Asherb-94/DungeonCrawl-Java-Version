    ...
    public sortie(Hero hero, Monster monster)
    {
        ...
        while (bothAlive && stay) //maybe problematic
        {
            ...
            if (hero.getHitPoints() <= 0)
            {
                System.out.print("\n\t\t\tYou moan... and die...\n\n");
                bothAlive = false;
                //TODO get out of function and call rip
            }
